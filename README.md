...
In the **Resizable Arrays in Optimal Time and Space** paper, there is a mistake in the `Locate` procedure (Algorithm 3, step 3, page 8 and the same on Algorithm 6, step 5.a, page 13 )
